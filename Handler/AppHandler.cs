...
//        private readonly IFeaturePageRepository _featureRepository;
...
//            IFeaturePageRepository featureRepository,
...
//        public async Task<List<FeaturePage>> GetFeatures() => await _featureRepository.GetAllFeatures();
//        public async Task<FeaturePage> GetFeatureById(int id) => await _featureRepository.GetFeatureById(id);
//        public async Task<FeaturePage> CreateFeature(FeaturePage feature) => await _featureRepository.InsertFeature(feature);
//        public async Task<FeaturePage> UpdateFeature(int id, FeaturePage feature) => await _featureRepository.UpdateFeature(id, feature);
